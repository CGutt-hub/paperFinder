...
def display_current_config(config: dict[str, str]) -> None:
...
def configure_openai(config: dict[str, str]) -> dict[str, str]:
...
def configure_semantic_scholar(config: dict[str, str]) -> dict[str, str]:
...
def configure_zotero(config: dict[str, str]) -> dict[str, str]:
